...
test('absorb should return true with an array of length greater than zero', function (t) {
  spritzjs.initializeState();
  // elect to use plain arrays as anything more exotic might make it less portable
  t.equal(spritzjs.absorb([0, 1, 2, 3]), true);
  t.end();
});
...
test('hash should disallow invalid arguments', function (t) {

  /* hash is essentially proxying the guard result of absorb */
  var hashed;
